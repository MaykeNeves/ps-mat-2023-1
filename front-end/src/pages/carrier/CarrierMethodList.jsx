...
export default function CarrierMethodList(){
    ...
    async function fetchData(){
        ...
        try{
            ...
            setState({...state, carrierMethods: result, showWaiting: false, showDialog: false })
        }
        catch(error){
            console.log(error)
    ...
    return (
        ...
        <PageTitle title="Listagem de Transportador" />
